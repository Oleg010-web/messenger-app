<template>
    ...
    <section class="py-2">
        <div class="h-16 w-full py-4 flex items-center px-2 hover:bg-gray-100 cursor-pointer" @click="showCreateGroupView">
            <div class="h-12 w-12 rounded-full bg-custom-whatsapp-1 flex items-center justify-center">
